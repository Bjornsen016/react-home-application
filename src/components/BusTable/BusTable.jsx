...
export default function BusTable() {
	...
	const [stopId, setstopId] = useState("9022014017320004"); //Pilgatan
	const [directionId, setdirectionId] = useState("9022014005279002"); //Gråbo busstation
						...
						<TableBody>
							{depInfo.DepartureBoard.Departure?.map((dep, index) => (
								...
								>
									...
									>
										{`${dep.rtTime} (${printDepartureTime(depInfo, dep)} min)`}
									</TableCell>
								</TableRow>
							))}
						</TableBody>
